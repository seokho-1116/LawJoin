...
class LawyerListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lawyerObjects.add(LawyerObjects("HanMunChul", "서울", "유명해요", "모든분야",
            R.drawable.ic_rectangle_background
        ))
        lawyerObjects.add(LawyerObjects("UmJunPyo", "수원", "좋아요", "모욕죄",
            R.drawable.ic_rectangle_background
        ))
        lawyerObjects.add(LawyerObjects("DaiByunHuak", "으잉", "멋있어요", "따이병후악",
            R.drawable.ic_rectangle_background
        ))
        lawyerObjects.add(LawyerObjects("한문철", "출신4", "리뷰", "카테고리",
            R.drawable.ic_rectangle_background
        ))
        lawyerObjects.add(LawyerObjects("엄준표", "출신5", "리뷰", "카테고리",
            R.drawable.ic_rectangle_background
        ))
        lawyerObjects.add(LawyerObjects("대병학", "출신6", "리뷰", "카테고리",
            R.drawable.ic_rectangle_background
        ))
        lawyerObjects.add(LawyerObjects("이름하나", "출신7", "리뷰", "카테고리",
            R.drawable.ic_rectangle_background
        ))
        lawyerObjects.add(LawyerObjects("이름둘", "출신8", "리뷰", "카테고리",
            R.drawable.ic_rectangle_background
        ))
        lawyerObjects.add(LawyerObjects("이름셋", "출신9", "리뷰", "카테고리",
            R.drawable.ic_rectangle_background
        ))
        lawyerObjects.add(LawyerObjects("이름넷", "출신10", "리뷰", "카테고리",
            R.drawable.ic_rectangle_background
        ))
