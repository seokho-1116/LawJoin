package com.example.lawjoin.post.adapter
...
class MyBoardFreeAdapter (private val lawyers: List<Lawyer>, var context: Context)
    : RecyclerView.Adapter<MyBoardFreeAdapter.LawyerListViewHolder>(), Filterable {
